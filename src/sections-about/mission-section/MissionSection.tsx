  ...
  return (
    <section className={`full-width base-layout section ${styles.section}`}>
      <article>
        ...
        <p>Aujourd’hui, j’interviens principalement <span className='highlight'>dans les Yvelines et le Val d’Oise</span> pour tous vos projets de peinture et rénovation.</p>
